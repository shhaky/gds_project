...
using MySql.Data.MySqlClient; //add reference
...
namespace Database_Connect_testVersion
{
    class DataHelper
    {
        ...
        //===================check if the user name is existed in database===================
        ...
        //===================get the lastest existed userId in database===================
        ...
        //=======================add new transaction=================================
        public bool addNewTransaction(long transId, long uerId, string transTime, string transType, string coinType, decimal amount, string toAdd)
        {
            string sql = "INSERT INTO transaction (TransId, UserId, TransTime, TransType, CoinType, Amount, ToAddress) VALUES('" + transId + "','" + uerId + "','" + transTime + "','" + transType + "','" + coinType + "','" + amount + "','" + toAdd + "')";
            MySqlCommand com = new MySqlCommand(sql, connection);
            connection.Open();
            com.ExecuteNonQuery();
            connection.Close();
