 ...
 * <p>
 * This Class is an extension of the traditional TradeEngine.
 * 
 * This additional Layer has the purpose to reduce Server processing time in a time of many requests
 * 
 * if there is a GET request for public info it wont calculate them over and over again, this class stores temporary
...
public class TradeEngineAutoUpdating extends TradeEngineManualUpdating implements Runnable{
	...
	@Override
	public List<Order> getBidDepth(CurrencyPair pair)
	...
	@Override
	public List<Order> getAskDepth(CurrencyPair pair)
			throws MarketNotAvailableException {
	...
	@Override
	public String getAskDepthAsJSON(CurrencyPair market)
			throws MarketNotAvailableException {
		// TODO Auto-generated method stub
		return null;
	}
	...
	@Override
	public String getBidDepthAsJSON(CurrencyPair market)
			throws MarketNotAvailableException {
		// TODO Auto-generated method stub
		return null;
	}
